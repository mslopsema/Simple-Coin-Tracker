...
public class TrackerTableModel extends AbstractTableModel {
    private String[] columnNames = {"Tracker", "Price/BTC", "1day Δ% BTC", "Price/USD", "1day Δ% USD"};
    ...
    public Object getValueAt(int row, int col) {
        switch (col) {
            ...
            case 1 : return list.get(row).priceBtc;
            case 2 : return list.get(row).deltaBtc;
            case 3 : return list.get(row).priceUsd;
            case 4 : return list.get(row).deltaUsd;
            default : return null;
        }
    }
